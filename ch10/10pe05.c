...
/*
 * Design a function update that accepts the date structure designed in Exercise
 * 10.4 to increment the date by one day and return the new date. The following
 ...
 *	-Wparentheses -Wformat-zero-length 10pe05.c -o binary/10pe05
 */
